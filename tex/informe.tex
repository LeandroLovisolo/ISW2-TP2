...
Como el sistema del TP2 está pensado para funcionar a nivel nacional, tuvimos que tener en cuenta detalles como la disponibilidad de conexión. Para esto, armamos un plan de respaldo en el caso de que la comunicación entre los distintos nodos se llegase a perder. En cambio, el sistema del TP1 no contempla esto dado que es un sistema muy pequeño que funciona en una computadora.
