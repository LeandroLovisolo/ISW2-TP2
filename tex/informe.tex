...
\item Guardar datos cifrados en servidores locales.
\end{itemize}
\end{itemize}
...
\textbf{Guardar datos cifrados en servidores locales.}\\
Los datos de los usuarios deben almacenarse encriptados en los servidores locales de su región correspondiente. Llamamos datos a los registros en la base de datos conteniendo la información necesaria para identificar a un usuario, como por ejemplo <nombre, apellido, dni, número de teléfono, es fumador>. Éstos deben guardarse encriptados para garantizar la confidencialidad de los mismos, por ejemplo, utilizando un sistema de encriptación de clave pública/privada.

\textbf{Creando una campaña desde el sector público/privado.}\\
La creación de una campaña consiste en ingresar un conjunto de mensajes con el horario en el que deben ser enviados, un conjunto de grupos de destinatarios concernientes al objetivo de la campaña, el método a través del que se enviarán.
...
Se solicita un usuario y contraseña cuando una persona intenta iniciar una sesión en el sistema para crear una campaña, consultar el estado de una campaña, etc. El sistema verifica que las credenciales ingresadas sean válidas, y en caso contrario deniega el acceso al mismo.
...
\begin{table}[h!]
    \begin{tabular}{lll}
	\hline
	CU1 & Guardar datos cifrados en servidores locales & 50h \\
	\hline \\
