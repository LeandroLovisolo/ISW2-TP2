...
\riesgo{1}
    {Es importante la disponibilidad constante del servicio, sin embargo se sabe que la red pública no tiene un 100 \% de cobertura en el territorio del país, además de que pueden presentarse problemas de conectividad (por ejemplo, zona patagónica).}
    {Media}
    {Alto}
    {Alta}
    {Utilizar el servicio provisto por la NSA}
    {No se}
